                        ...
                        <div class="footer_box"> 
                            ...
                            <?php echo form_open('enquiry/home/create', array('id' => 'enquiryFrm')) ?>
                                <div class="form-group">
                                    <input name="name" class="form-control" id="en_name" type="text" placeholder="<?php echo display('name') ?>">
                                </div>

                                <div class="form-group">
                                    <input name="email" class="form-control" id="en_email" type="text" placeholder="<?php echo display('email') ?>">
                                </div> 

                                <div class="form-group">
                                <input type='text' name="phone" class='form-control' id="en_phone"  placeholder="<?php echo display('phone') ?>" >
                                </div>

                                <div class="form-group">
                                    <textarea name="enquiry" id="en_enquiry" placeholder="<?php echo display('enquiry') ?>" class="form-control"></textarea>
                                </div> 
                    ...
                    <div class="col-sm-3">
                        <div class="footer_box">
                            ...
                            <?= form_open('ticket/feedback/form', array('id'=>'ratingFrm')) ?>
                                ...
                                <div class="form-group">
                                    <input name="tkt_booking_id_no" class="form-control" type="text" placeholder="<?php echo display('booking_id') ?>"  value="" id="r_booking_id">
                                </div> 
             
                                <div class="form-group">
                                    <input name="name" class="form-control" type="text" placeholder="<?php echo display('name') ?>" value="" id="r_name" readonly>
                                </div> 
                                ...
                                <div class="form-group">
                                    <textarea name="comment" id="r_comments" placeholder="<?php echo display('comment') ?>" class="form-control"></textarea>
                                </div> 
